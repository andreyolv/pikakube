...
- Elasticsearch or [OpenSearch](../../storage/opensearch/) is the destination, and the rest of the Elastic tooling is already in place
...
- greenfield anything — [Fluent Bit](../fluent/fluent-bit/) for shipping, [Vector](../vector/) for transformation
- resources are constrained

## If it has to be in the picture

Do not run it as the node agent. Use [Fluent Bit](../fluent/fluent-bit/) as the DaemonSet and
