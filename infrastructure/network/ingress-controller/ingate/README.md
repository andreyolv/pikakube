...
The motivation is straightforward: [ingress-nginx](../ingress-nginx/README.md) is the de facto default
...
- anything you depend on today — use [ingress-nginx](../ingress-nginx/README.md) or a mature
