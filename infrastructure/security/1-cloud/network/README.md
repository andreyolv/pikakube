...
[`ips`](ips/README.md) · [`vpn`](vpn/README.md) · [`opennhp`](opennhp/README.md) — ZTNA / network hiding
...
| **ZTNA / network hiding** | nothing — it decides whether the port answers **at all**, before any connection | in front of non-public services: admin interfaces, SSH, an API server | [→](opennhp/README.md) |
...
[`opennhp/`](opennhp/README.md) is the same principle applied where the answer is *"reachable, but
